      ...
      <div className="mx-auto max-w-6xl space-y-6 px-4">
        <section className="rounded-2xl border border-slate-200 bg-white p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <p className="text-sm font-semibold uppercase tracking-wide text-blue-600">Writing AI - 3 points</p>
        ...
        {result ? (
          <section className="space-y-6">
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="text-left sm:text-right">
                  ...
                  <p className="text-sm font-semibold text-red-600">-{result.points?.spent ?? 3} diem</p>
                </div>
              </div>
            ...
            <section className="rounded-xl border border-slate-200 bg-white p-5">
              ...
              <p className="mt-4 whitespace-pre-line text-sm leading-6 text-slate-700">{result.data.improvements.improved_version}</p>
            </section>
          </section>
        ) : null}
      </div>
