...
export default function ResultsClient({ initialResults }: { initialResults: StudentResultItem[] }) {
  const [filter, setFilter] = useState<ResultFilter>("all");
  const results = useMemo(() => filterResults(initialResults, filter), [filter, initialResults]);
