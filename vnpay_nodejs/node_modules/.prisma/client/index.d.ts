...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "order" | "paymentTransaction"
  ...
  export type OrderOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "orderCode" | "amount" | "status" | "description" | "bankCode" | "locale" | "vnpTransactionNo" | "responseCode" | "ipAddress" | "createdAt" | "updatedAt", ExtArgs["result"]["order"]>
  ...
  export interface Prisma__OrderClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    transactions<T extends Order$transactionsArgs<ExtArgs> = {}>(args?: Subset<T, Order$transactionsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$PaymentTransactionPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
  ...
  interface OrderFieldRefs {
    ...
    readonly bankCode: FieldRef<"Order", 'String'>
    readonly locale: FieldRef<"Order", 'String'>
    readonly vnpTransactionNo: FieldRef<"Order", 'String'>
    readonly responseCode: FieldRef<"Order", 'String'>
    readonly ipAddress: FieldRef<"Order", 'String'>
  ...
  export type PaymentTransactionOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "orderId" | "txnRef" | "amount" | "responseCode" | "vnpTransactionNo" | "bankCode" | "status" | "rawPayload" | "source" | "createdAt", ExtArgs["result"]["paymentTransaction"]>
  ...
  interface PaymentTransactionFieldRefs {
    ...
    readonly orderId: FieldRef<"PaymentTransaction", 'Int'>
    readonly txnRef: FieldRef<"PaymentTransaction", 'String'>
    readonly amount: FieldRef<"PaymentTransaction", 'Int'>
    readonly responseCode: FieldRef<"PaymentTransaction", 'String'>
    readonly vnpTransactionNo: FieldRef<"PaymentTransaction", 'String'>
    readonly bankCode: FieldRef<"PaymentTransaction", 'String'>
    readonly status: FieldRef<"PaymentTransaction", 'String'>
    readonly rawPayload: FieldRef<"PaymentTransaction", 'String'>
    readonly source: FieldRef<"PaymentTransaction", 'String'>
  ...
  export type OrderWhereInput = {
    ...
    bankCode?: StringNullableFilter<"Order"> | string | null
    locale?: StringFilter<"Order"> | string
    vnpTransactionNo?: StringNullableFilter<"Order"> | string | null
    responseCode?: StringNullableFilter<"Order"> | string | null
    ipAddress?: StringNullableFilter<"Order"> | string | null
  ...
  export type OrderScalarWhereWithAggregatesInput = {
    ...
    bankCode?: StringNullableWithAggregatesFilter<"Order"> | string | null
    locale?: StringWithAggregatesFilter<"Order"> | string
    vnpTransactionNo?: StringNullableWithAggregatesFilter<"Order"> | string | null
    responseCode?: StringNullableWithAggregatesFilter<"Order"> | string | null
    ipAddress?: StringNullableWithAggregatesFilter<"Order"> | string | null
  ...
  export type PaymentTransactionWhereInput = {
    ...
    orderId?: IntFilter<"PaymentTransaction"> | number
    txnRef?: StringFilter<"PaymentTransaction"> | string
    amount?: IntFilter<"PaymentTransaction"> | number
    responseCode?: StringNullableFilter<"PaymentTransaction"> | string | null
    vnpTransactionNo?: StringNullableFilter<"PaymentTransaction"> | string | null
    bankCode?: StringNullableFilter<"PaymentTransaction"> | string | null
    status?: StringFilter<"PaymentTransaction"> | string
    rawPayload?: StringNullableFilter<"PaymentTransaction"> | string | null
    source?: StringFilter<"PaymentTransaction"> | string
  ...
  export type PaymentTransactionScalarWhereWithAggregatesInput = {
    ...
    orderId?: IntWithAggregatesFilter<"PaymentTransaction"> | number
    txnRef?: StringWithAggregatesFilter<"PaymentTransaction"> | string
    amount?: IntWithAggregatesFilter<"PaymentTransaction"> | number
    responseCode?: StringNullableWithAggregatesFilter<"PaymentTransaction"> | string | null
    vnpTransactionNo?: StringNullableWithAggregatesFilter<"PaymentTransaction"> | string | null
    bankCode?: StringNullableWithAggregatesFilter<"PaymentTransaction"> | string | null
    status?: StringWithAggregatesFilter<"PaymentTransaction"> | string
    rawPayload?: StringNullableWithAggregatesFilter<"PaymentTransaction"> | string | null
    source?: StringWithAggregatesFilter<"PaymentTransaction"> | string
